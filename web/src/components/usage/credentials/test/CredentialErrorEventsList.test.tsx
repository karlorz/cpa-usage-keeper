...
import { TestResizeObserver } from '../../test/virtualizationFixtures'
...
describe('CredentialErrorEventsList', () => {
  ...
  beforeEach(() => {
    ...
    vi.spyOn(HTMLElement.prototype, 'getBoundingClientRect').mockImplementation(function getBoundingClientRect() {
      if (this.dataset.index !== undefined) {
        ...
        return new DOMRect(0, 0, 920, 180 + (index % 3) * 60)
      }
  ...
  it('fully renders a small error page without virtual positioning', async () => {
    ...
    expect(scroller.querySelector('[data-credential-error-event-id="1"]')!.textContent).toContain('rate_limit')
  })
})
